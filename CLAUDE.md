...
- **Phase 3c** — A FAIRE. Bulk vendu (sélecteur multi-cartes vendues ensemble + division du prix de vente entre les cartes) + Refining Gemini tokens (audit input/output + optimisation pipeline coût). Brief : [PHASE_3.md](PHASE_3.md).
